    ...
    <div className="flex flex-col h-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 flex-grow">
        <div className="flex flex-col items-center justify-center p-4 bg-secondary/50 rounded-lg">
          <Image src="/slide3-1.png" alt="Blog content" width={600} height={400} className="rounded-md shadow-md mb-4" data-ai-hint="writing desk"/>
        ...
        <div className="flex flex-col items-center justify-center p-4 bg-secondary/50 rounded-lg">
          <Image src="/slide3-2.png" alt="Video content" width={600} height={400} className="rounded-md shadow-md mb-4" data-ai-hint="video camera"/>
